...
struct TipApproacher {
  ...
  static constexpr float setpointVoltage = 1.0;
  ...
  // to 0.5-1.2 V in ambient conditions. Large bias voltages might also
  // change it.
  //
  // 4.0 V -> 112 pm per decade
  // 1.0 V -> 225 pm per decade
  // 0.5 V -> 318 pm per decade
  static constexpr float tunnelingBarrierHeight = 1.0; // V
